...
public class DataSource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:C:\\Work\\Java\\Course\\MusicDB\\" + DB_NAME;
    ...
    private int insertArtist(String name) throws SQLException {
        ...
        if (results.next())
            return results.getInt(1); // this artist already exists
        else {
